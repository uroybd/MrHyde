...
["", "main.dart", , F, {
  ...
  outputRequestComplete: function(h) {
    ...
    H.checkInt(0);
    t1.length;
    response = H.stringReplaceFirstUnchecked(t1, t2, "", 0);
    t1 = $.s;
    if (t1 == null)
      return t1.$add();
    $.s = t1 + response;
    list = response.split("\n");
    for (t1 = new H.ListIterator(list, list.length, 0, null); t1.moveNext$0();) {
      line = t1.__internal$_current;
      if (!J.$eq(line, "")) {
        element = document.createElement("li", null);
  ...
  timerTrigger_closure: {
    ...
    call$1: function(e) {
      return F.outputRequestComplete(this.httpRequest_0);
    }
  },
